-- LEGACY deploy SQL — prefer database/production_schema.sql for new installs
-- (production_schema.sql includes debt tables + users staff columns, NO default admin login)
-- Create admin via database/create_production_admin.private.sql.example
