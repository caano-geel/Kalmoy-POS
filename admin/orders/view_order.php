...
$order = $conn->query("SELECT o.*,concat(c.firstname,' ',c.lastname) as client FROM `orders` o inner join clients c on c.id = o.client_id where o.id = '{$_GET['id']}' ".tenant_sql('o'));
if($order->num_rows > 0){
...
<div class="card card-outline card-primary">
    <div class="card-body">
        <div class="conitaner-fluid">
            <p><b>Customer: <?php echo $client ?></b></p>
            <p><b>Delivery Address: <?php echo $delivery_address ?></b></p>
            <div class="ash-table-wrap">
            <table class="table-striped table table-bordered ash-table" id="list">
                <colgroup>
                    <col width="15%">
                    <col width="35%">
                    <col width="25%">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="text-right ash-col-money">Total</th>
                    </tr>
                </thead>
                <tbody>
                    <?php 
                    ...
                    <tr>
                        ...
                        <td class="text-right"><?php echo ash_format_money_cell($row['price'] * $row['quantity'], 'revenue') ?></td>
                    </tr>
                    <?php endwhile; ?>
                </tbody>
                <tfoot>
                    <tr>
                        ...
                        <th class="text-right"><?php echo ash_format_money_cell($amount, 'revenue') ?></th>
                    </tr>
                </tfoot>
            </table>
        </div>
        <div class="row">
            <div class="col-6">
                ...
                <?php if(admin_cashier_can('orders_manage') && !isset($_GET['view']) && $paid == 0 && $status!= 4): ?>
            ...
            <div class="col-6 row row-cols-2">
                ...
                <?php if(admin_cashier_can('orders_manage') && !isset($_GET['view'])): ?>
                <div class="col-3"></div>
                <div class="col">
...
<div class="modal-footer">
    <?php if(admin_cashier_can('orders_manage') && isset($status) && $status == 0): ?>
