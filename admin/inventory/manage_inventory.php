	...
	<div class="card-body">
		<form action="" id="inventory-form">
            ...
            <div class="form-group">
                ...
                <input type="number" step="any" min="0" class="form-control form" required name="price" value="<?php echo isset($price) ? $price : '' ?>">
            </div>
            <?php if(admin_can_view_profit()): ?>
            <div class="form-group">
				<label for="cost_price" class="control-label">Cost Price</label>
                <input type="number" step="any" min="0" class="form-control form" name="cost_price" value="<?php echo isset($cost_price) ? $cost_price : '0' ?>">
                <small class="text-muted">Purchase/buying price used for profit calculation.</small>
            </div>
            <?php endif; ?>
		</form>
	</div>
