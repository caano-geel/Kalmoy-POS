            ...
            <div class="container px-4 px-lg-5 ">
                ...
                <form class="form-inline" id="search-form">
                  <div class="input-group">
                    <input class="form-control form-control-sm form " type="text" placeholder="Search name or scan barcode" aria-label="Search" name="search" autocomplete="off" value="<?php echo isset($_GET['search']) ? $_GET['search'] : "" ?>"  aria-describedby="button-addon2">
